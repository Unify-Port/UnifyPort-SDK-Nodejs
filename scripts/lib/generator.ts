...
const POLICY_OVERRIDES: Readonly<Partial<Record<OperationPolicyKey, PolicyOverride>>> = {
  ...
  "device:createAccount": { secretInput: true, mcpExposure: "never" },
  "device:updateAccount": { secretInput: true, mcpExposure: "never" },
  "device:sendMessage": { secretInput: true, mcpExposure: "never" },
